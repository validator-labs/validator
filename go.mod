...
require (
	buf.build/gen/go/spectrocloud/spectro-cleanup/connectrpc/go v1.18.1-20240205164452-95dfd137cb54.1
	buf.build/gen/go/spectrocloud/spectro-cleanup/protocolbuffers/go v1.36.5-20240205164452-95dfd137cb54.1
